...
All project names, people, records, amounts, geometry, observations, and timestamps are fictional. See **Sources & seams** in the interface and `pm-day-guide.md` for the source register and evidence boundaries.
